            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i> Encuesta basica</a>
                        </li>
                        <li>
...
if($enviado == 1 && $contenido == 1) {
  ...
  $error = 'Por favor, ingrese su color favorito.';
} else if(empty($fecha)) {
  $error = 'Por favor, ingrese su fecha de nacimiento.';
} else if(empty($pagina)) {
  $error = 'Por favor, ingrese su pagina personal.';
//} else if(empty($sexo)) {
  //$error = 'Por favor, ingrese su sexo.';
//} else if(empty($region)) {
  //$error = 'Por favor, eliga su region';
//} else if(empty($areainteres)) {
  //$error = 'eliga su area de interes';
}
...
<!--<a href="./" class="btn btn-warning">
  ...
  Volver
</a>  boton del volver despues de tirar error-->
<?php
// Vista de éxito
} else {
  // Subir imagen
...
?>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <p>
        y su apellido es: <b><?php echo $apellido; ?></b>
      </p>
      <p>
        Tu correo es: <b><?php echo $correo; ?></b>
      </p>
      <p>
        Tu fecha de naciemiento es: <b><?php echo $fecha; ?></b>
      </p>
      <p>
        Tu sexo es: <b><?php if ($sexo == 'femenino') {
                                echo "Femenino";
...
<?php } ?>
  ...
  <footer>
    <div class="text-center">
      ...
      Desarrollado por <a href="https://github.com/weblazko" target="_blank">Consuelo Quiroga</a>
    </div>
  </footer>
</div>
</body>
